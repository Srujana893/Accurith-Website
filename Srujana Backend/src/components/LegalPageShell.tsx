  ...
  return (
    <Section tone="white" hairline={false} className="md:py-24">
      <Container className="max-w-2xl">
        <p className="mb-3 font-mono text-xs tracking-widest text-teal-700 uppercase">Legal</p>
        <h1 className="text-4xl leading-tight tracking-tight md:text-5xl">{title}</h1>
        ...
        >
          ...
          <p className="text-sm leading-relaxed text-amber-900">
            <strong className="font-medium">Draft — pending legal review.</strong> This page is a
            structural placeholder. Final wording will be prepared and approved by counsel before
            launch.
          </p>
        </div>
