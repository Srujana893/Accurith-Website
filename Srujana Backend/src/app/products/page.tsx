      ...
      <Section tone="white" hairline={false} dotGrid className="md:py-28">
        <Container>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-slate-700">
            We&apos;re productising the automation we use in our own engagements. The platforms
            below are in testing with early users now — no public screenshots or pricing until
            they&apos;ve earned them.
          </p>
        </Container>
      </Section>
          ...
          <RevealGroup className="mt-12 grid gap-6 md:grid-cols-3">
            {products.map((p) => (
              ...
              >
                ...
                <h3 className="text-navy mt-4 text-lg font-medium">{p.name}</h3>
