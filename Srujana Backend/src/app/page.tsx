import { FileSearch, Activity, Radar, ArrowRight } from 'lucide-react';
...
import { credentials, featuredServices, frameworks } from '@/components/siteData';
...
const methodologySteps = [
  {
    number: '01',
    title: 'Assess',
    description: 'Understand your environment, obligations, and current control posture.',
  },
  {
    number: '02',
    title: 'Design',
    description: 'Define the controls, policies, and remediation plan that fit your risk.',
  },
  {
    number: '03',
    title: 'Implement',
    description: 'Execute alongside your teams — hands-on, evidence-driven, on schedule.',
  },
  {
    number: '04',
    title: 'Monitor',
    description: 'Keep controls operating with continuous monitoring and periodic review.',
  },
];
...
const aiFeatures = [
  ...
  },
  {
    ...
    description: 'Know when a control drifts out of tolerance — not at the next annual review.',
  },
  {
    icon: Radar,
    title: 'Anomaly detection',
    description: 'Surface unusual transactions and access patterns for auditor review, early.',
  },
];
    ...
    <>
      ...
      <Section tone="white" hairline={false} dotGrid className="md:py-32">
        <Container>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-slate-700">
            Accurith is a cybersecurity, IS-audit, and GRC advisory firm — with audit-automation
            platforms on the way. We help you prove your controls work.
          </p>
      ...
      >
        <Container className="flex flex-col gap-3 md:flex-row md:items-center md:gap-6">
          <p className="shrink-0 font-mono text-xs tracking-widest text-slate-500 uppercase">
        ...
        <Container>
          ...
          <RevealGroup className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {roles.map((r) => (
              ...
              >
                <p className="text-navy font-mono text-xs tracking-widest uppercase">{r.role}</p>
                <p className="mt-3 flex-1 text-sm leading-relaxed text-slate-700">{r.painPoint}</p>
                <a
                  href="/services"
      ...
      <Section tone="navy" dotGrid>
        <Container>
          ...
          <RevealGroup className="mt-12 grid gap-8 md:grid-cols-3">
            {aiFeatures.map((f) => (
              <div key={f.title}>
                <f.icon aria-hidden="true" size={24} strokeWidth={1.75} className="text-teal-300" />
      ...
      <Section tone="grey">
        <Container className="max-w-3xl text-center">
          ...
          <p className="mt-4 text-lg leading-relaxed text-slate-700">
            The automation platforms we use in our own engagements — evidence collection, controls
            monitoring, and audit workpapers — are in testing now, ahead of general availability.
          </p>
          <div className="mt-8">
      ...
      <Section tone="white">
        <Container className="max-w-3xl text-center">
          <h2 className="text-2xl leading-tight tracking-tight md:text-4xl">Ready to talk?</h2>
          <p className="mt-4 text-lg leading-relaxed text-slate-700">
            Tell us what you need to prove, protect, or automate. We respond within one business
            day.
          </p>
          <div className="mt-8">
            <Button href="/contact" size="lg">
