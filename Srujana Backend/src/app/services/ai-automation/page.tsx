  ...
  return (
    <ServicePageTemplate
      ...
      methodology={[
        {
          title: 'Map',
          description: 'Break the process into judgement steps and mechanical steps.',
        },
        {
          title: 'Automate',
          description: 'Build the mechanical layer: extraction, matching, monitoring, drafting.',
        },
        {
          title: 'Validate',
          description: 'Run automated output alongside the manual process until it proves itself.',
        },
        {
          title: 'Operate',
          description: 'Hand over a monitored, documented pipeline your team controls.',
        },
      ]}
      frameworksAlignedTo={['COBIT', 'ISO 27001', 'NIST AI RMF', 'SOC 2']}
      relevantRoles={['Head of Internal Audit', 'CISO', 'CRO', 'Finance transformation leads']}
      relevantIndustries={[
        'Banking & fintech',
        'Insurance',
        'SaaS & technology',
