  ...
  return (
    <ServicePageTemplate
      ...
      methodology={[
        {
          title: 'Scope',
          description: 'Define targets, rules of engagement, and success criteria with your team.',
        },
        {
          title: 'Test',
          description:
        ...
        {
          title: 'Report',
          description: 'Deliver risk-rated findings with reproduction steps and concrete fixes.',
        },
        {
          title: 'Verify',
          description: 'Retest remediated findings and confirm closure with evidence.',
        },
      ]}
      frameworksAlignedTo={['ISO 27001', 'NIST CSF', 'PCI-DSS', 'CIS Controls']}
      relevantRoles={['CISO', 'Security leads', 'Heads of Engineering', 'CTO']}
      relevantIndustries={['Banking & fintech', 'Insurance', 'Healthcare', 'SaaS & technology']}
    />
  );
}
