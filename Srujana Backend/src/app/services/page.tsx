...
import { additionalServices, featuredServices } from '@/components/siteData';
  ...
  return (
    <>
      <Section tone="white" hairline={false} dotGrid className="md:py-28">
        <Container>
          <p className="mb-3 font-mono text-xs tracking-widest text-teal-700 uppercase">Services</p>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-slate-700">
            Six service lines, one method: scope precisely, test properly, and leave you with
      ...
      <Section tone="white">
        <Container>
          <SectionHeading index="02" label="Additional" title="Additional services" />
      ...
      <Section tone="grey">
        <Container className="max-w-3xl text-center">
          ...
          <p className="mt-4 text-lg leading-relaxed text-slate-700">
            Describe the problem — an upcoming audit, a security concern, a board question — and
            we&apos;ll scope the right entry point.
          </p>
          <div className="mt-8">
