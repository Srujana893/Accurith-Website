  ...
  return (
    <>
      <Section tone="white" hairline={false} dotGrid className="md:py-28">
        <Container>
          <p className="mb-3 font-mono text-xs tracking-widest text-teal-700 uppercase">About</p>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-slate-700">
            Accurith Technologies Private Limited is a cybersecurity, IS-audit, and GRC advisory
            firm based in Bengaluru, India. We started Accurith because assurance work deserves both
            discipline and better tooling — so we deliver the first and build the second.
          </p>
        </Container>
      </Section>
      ...
      <Section tone="grey">
        <Container className="max-w-3xl">
          ...
          <p className="mt-6 text-lg leading-relaxed text-slate-700">
            Help organisations prove their controls work — to auditors, regulators, customers, and
            themselves — and automate the parts of that proof that never needed a human in the first
            place. We measure ourselves the way our clients are measured: on evidence.
          </p>
        </Container>
      </Section>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {leadershipPlaceholders.map((person) => (
              ...
              >
                ...
                <h3 className="text-navy mt-3 text-lg font-medium">{person.title}</h3>
                <p className="font-mono text-xs tracking-widest text-slate-500 uppercase">
                  Placeholder profile
                </p>
                <p className="mt-2 text-sm leading-relaxed text-slate-700">{person.bio}</p>
              </div>
            ))}
          </div>
        </Container>
