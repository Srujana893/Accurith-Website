          ...
          <div>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              ...
              >
                ...
                />
                <p className="font-heading text-navy mt-4 text-lg font-medium">Card title</p>
                <p className="mt-1 text-sm leading-relaxed text-slate-700">
                  Hover me — border tint + shadow lift, 200ms ease-out. Note the 8px corner ticks.
                </p>
              </a>
            </div>
          </div>
      ...
      <Section tone="white">
        <Container>
          ...
          <div className="mt-8 space-y-4">
            <p className="text-navy text-6xl leading-tight tracking-tight">6xl display</p>
            <p className="text-navy text-5xl leading-tight tracking-tight">5xl display</p>
            <p className="text-navy text-4xl leading-tight tracking-tight">4xl heading</p>
            <p className="text-navy text-2xl">2xl heading</p>
            <p className="text-navy text-xl">xl heading</p>
